...
export default function AdminCustomCard(props: Props) {
    ...
    const headingProfile = ["user_id", "user_name", "email", "broker", "exchanges", "order_types", "products"];
    console.log(profileDetails,"profileDetailszdsfd")
    return (
