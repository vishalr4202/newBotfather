    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '15px', flexWrap: 'wrap', marginTop: '40px' }}>
                ...
                <Autocomplete data={strikePrice} change={(e: any) => setStrike(e)} value={selectedStrike} style={{ width: '180px' }} putBuy={true} />
                <Autocomplete data={strikePrice} change={(e: any) => setPutStrike(e)} value={selectedPutStrike} style={{ width: '180px' }} putSell={true} />
